...
public class SimulatorGUI extends JFrame {
    ...
    private JComponent buildTeamTab() {
        ...
        membersGrid.add(memberCard("01", "Team Member 1", "Public profile available on request", "Contributor", "-"));
        membersGrid.add(memberCard("02", "Team Member 2", "Public profile available on request", "Contributor", "-"));
        membersGrid.add(memberCard("03", "Basmala Allam Anwar", "Public profile available on request", "Contributor", "-"));
        membersGrid.add(memberCard("04", "Team Member 4", "Public profile available on request", "Contributor", "-"));
        membersGrid.add(memberCard("05", "Team Member 5", "Public profile available on request", "Contributor", "-"));
